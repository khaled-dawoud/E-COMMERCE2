                    ...
                    <div class="container">
                        <div class="row center">
                            <div class="content-404 col-lg-6 col-sm-6 text-center">
                                <div class="image">
                                    <img class="img-fluid" src="{{ asset('frontend/img/other/image-404.png') }}" alt="Image 404">
                                </div>
                                ...
                                <a class="btn btn-default" href="{{ route('site.index') }}">
                            ...
                            <div class="content-right-404 col-lg-6 col-sm-6 text-center">
                                <a href="#">
                                    <img class="img-fluid" src="{{ asset('frontend/img/other/background.jpg') }}" alt="image 404 right">
                                </a>
                            </div>
                        </div>
                    </div>
