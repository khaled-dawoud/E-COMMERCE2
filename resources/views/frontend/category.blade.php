            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-2 col-md-2 d-flex align-items-center">
                        <div id="logo">
                            <a href="{{ route('site.index') }}">
                                <img src="{{ asset('frontend/img/home/logo.png') }}" alt="logo" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-5 col-md-5 align-items-center justify-content-center navbar-expand-md main-menu">
                        <div class="menu navbar collapse navbar-collapse">
                            <ul class="menu-top navbar-nav">
                                <li>
                                    <a href="{{ route('site.index') }}" class="parent">Home</a>
                                </li>
                                <li>
        ...
        <div id="wrapper-site">
            <div id="content-wrapper" class="full-width">
                <div id="main">
                    <div class="page-home">
                        <!-- breadcrumb -->
                        <nav class="breadcrumb-bg p-2 mb-3">
                                            ...
                                            <div class="block-content">
                                                @foreach ($categories as $item)
                                                    <div class="cateTitle hasSubCategory open level1">
                                                        ...
                                                        <a class="cateItem" href="#">{{ $item->name }}</a>
                                                    </div>
                                                @endforeach
                                            </div>
                                            ...
                                            <div class="d-flex justify-content-around row">
                                                <div class="col col-xs-12">
                                                    ...
                                                    <div class="hidden-sm-down total-products">
                                                        <p>There are <span class="badge badge-primary">{{ $category->products->count() }}</span> products.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="item text-center col-md-6">
                                                            <div class="product-miniature js-product-miniature item-one first-item">
                                                                <div class="thumbnail-container border">
                                                                    <a href="product-detail.html">
                                                                        <img class="img-fluid image-cover" src="{{ asset('uploads/images/products/'.$product->image) }}" alt="img">
                                                                        <img class="img-fluid image-secondary" src="{{ asset('frontend/img/product/22.jpg') }}" alt="img">
                                                                    </a>
                                                        ...
                                                        <div class="product-miniature js-product-miniature item-one first-item">
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="thumbnail-container border">
                                                                        <a href="product-detail.html">
                                                                            <img class="img-fluid image-cover" src="{{ asset('frontend/img/product/11.jpg') }}" alt="img">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="thumbnail-container border">
                                                                        <a href="product-detail.html">
                                                                            ...
                                                                            <img class="img-fluid image-secondary" src="{{ asset('frontend/img/product/23.jpg') }}" alt="img">
                                                                        </a>
                                                                    </div>
